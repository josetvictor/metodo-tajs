...
Para poder navegar pelo codigo, acesso o projeto clonado no terminal e pode abrir com seu editor de texto preferido

```bash
cd metodo-tajs
```
após acessar o projeto, veja que cada modolu do treinamento está em um diretorio diferente, para acessar e rodar o projeto basta acessar e rodar os scripts presentes no arquivo `package.json`
